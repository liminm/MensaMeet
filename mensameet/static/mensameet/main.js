	...
	var membersFilter, topicsFilter, topicsFilterArr, mensaFilter, dateFilter, myFilter;
	...
	$( "#show-my-meetups" ).on( "click", function() {
		if ($( "#show-my-meetups" ).attr("class")=="checked") {
			myFilter=true;
			$("#show-my-meetups").removeClass("checked");
			$("#show-my-meetups").addClass("not");
			}
		else {
			myFilter=false;
			$("#show-my-meetups").removeClass("not");
			$("#show-my-meetups").addClass("checked");
			}
